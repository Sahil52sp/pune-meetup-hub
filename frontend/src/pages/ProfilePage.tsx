        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <Label>Open for Connections</Label>
              ...
              <Switch
                ...
                onCheckedChange={(checked) => setProfile({...profile, is_open_for_connection: checked})}
                disabled={!isEditing}
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => setProfile({...profile, contact_preferences: e.target.value})}
                disabled={!isEditing}
