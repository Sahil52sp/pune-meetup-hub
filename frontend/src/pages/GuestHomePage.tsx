...
export default function GuestHomePage() {
  ...
  // Sort events: featured first, then by date, then take first 3
    ...
    <>
      <Box className="min-h-screen bg-background relative px-4 sm:px-8 md:mx-16 lg:mx-24 xl:mx-40">
        ...
        <Box className="relative overflow-hidden py-12 sm:py-16 md:py-20 lg:py-28 z-10">
          <Box className="max-w-5xl text-center sm:text-left mx-auto sm:mx-0">
            <h1 className="text-4xl sm:text-5xl md:text-5xl lg:text-6xl nouvel-bold mb-4 sm:mb-6 text-foreground">
              Where Every Connection Elevates <br />
              <span className="text-primary">Your Network</span>
            </h1>
            <p className="text-base sm:text-lg md:text-lg text-muted-foreground max-w-2xl text-center sm:text-left leading-relaxed mx-auto sm:mx-0">
              Set up your profile, go online when ready, and browse
              professionals by interests and skills. Send meetup requests to
